    ...
    <section id="comparativo" className="py-20 md:py-28 bg-white border-y border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
          ...
          >
            <div>
              <div className="inline-flex items-center gap-2 bg-rose-100 text-rose-700 px-3 py-1 rounded-full text-xs font-bold mb-6">
                <AlertCircle size={14} />
            ...
            <p className="text-xs text-rose-700 font-semibold mt-8 pt-4 border-t border-rose-200/60">
