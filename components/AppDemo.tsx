    ...
    <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative rounded-2xl border border-slate-200 bg-white shadow-2xl overflow-hidden max-w-5xl mx-auto">
        <div className="bg-slate-100/80 border-b border-slate-200 px-4 py-3 flex items-center justify-between">
          ...
          <div className="bg-white border border-slate-200 rounded-md px-4 py-1 text-xs font-mono text-text-muted shadow-inner">
          ...
          <AnimatePresence mode="wait">
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                    <span className="text-xs font-medium text-text-muted">Sessões da Semana</span>
                    <p className="text-2xl font-bold text-text-main mt-1">14 matérias</p>
                    <span className="text-xs text-progress font-semibold">+22% em relação a semana passada</span>
                  </div>
                  <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                    <span className="text-xs font-medium text-text-muted">Taxa de Acerto</span>
                    <p className="text-2xl font-bold text-text-main mt-1">92.4%</p>
                    <span className="text-xs text-primary font-semibold">Excelente retenção</span>
                  </div>
                  <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                    <span className="text-xs font-medium text-text-muted">Sequência de Estudos</span>
                    <p className="text-2xl font-bold text-text-main mt-1">12 Dias</p>
                    <span className="text-xs text-accent font-semibold">Fluxo diário mantido</span>
                  </div>
                </div>

                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                  <h4 className="text-sm font-bold text-text-main mb-4">Progresso Geral por Disciplina</h4>
            ...
            {activeTab === "flashcards" && (
              ...
              >
                ...
                <p className="text-xs text-text-muted mb-8">Clique para virar o cartão ou selecione seu nível de facilidade</p>
                <div className="grid grid-cols-3 gap-3">
                  <button className="py-2.5 bg-rose-50 text-rose-600 border border-rose-200 rounded-xl text-xs font-bold hover:bg-rose-100 transition-colors">
                    Difícil
                  </button>
                  <button className="py-2.5 bg-amber-50 text-amber-600 border border-amber-200 rounded-xl text-xs font-bold hover:bg-amber-100 transition-colors">
                    Bom
                  </button>
                  <button className="py-2.5 bg-emerald-50 text-emerald-600 border border-emerald-200 rounded-xl text-xs font-bold hover:bg-emerald-100 transition-colors">
                    Fácil
                  </button>
                </div>
              </motion.div>
            ...
            {activeTab === "testes" && (
              ...
              >
                <div className="flex justify-between items-center mb-4">
                  <span className="text-xs font-bold text-text-muted">Questão 3 de 10</span>
                  <span className="text-xs font-bold text-primary">Tempo restante: 01:45</span>
                </div>
                ...
                <div className="space-y-2">
                  <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg text-xs font-medium text-text-main">
                    A) Complexo de Golgi
                  </div>
                  <div className="p-3 bg-primary/10 border border-primary text-primary rounded-lg text-xs font-bold flex justify-between items-center">
                    <span>B) Mitocôndria</span>
                    <span className="text-[10px] bg-primary text-white px-2 py-0.5 rounded">Selecionada</span>
                  </div>
                  <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg text-xs font-medium text-text-main">
                    C) Ribossomo
                  </div>
            ...
            {activeTab === "organizacao" && (
              ...
              >
                <h4 className="text-sm font-bold text-text-main mb-4">Cadernos & Tópicos de Estudo</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl flex items-center gap-3">
                    <div className="w-3 h-3 rounded-full bg-primary" />
                    <div>
                      <h5 className="text-xs font-bold text-text-main">Medicina / Anatomia</h5>
                      <p className="text-[10px] text-text-muted">28 itens organizados</p>
                    </div>
                  </div>
                  <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl flex items-center gap-3">
                    <div className="w-3 h-3 rounded-full bg-secondary" />
                    <div>
                      <h5 className="text-xs font-bold text-text-main">Concursos / Direito Const.</h5>
                      <p className="text-[10px] text-text-muted">42 itens organizados</p>
                    </div>
                  </div>
                </div>
              </motion.div>
